  ...
  return (
    ...
    >
      <h1 className="mb-10 max-w-[400px] font-serif text-heading-lg text-white sm:mb-9 sm:max-w-[573px] sm:text-heading-2xl md:max-w-[635px] md:text-heading-3xl lg:text-heading-4xl">
        Data{" "}
        <span className="relative after:absolute after:bottom-0 after:left-0 after:mb-[4px] after:h-[3px] after:bg-accent after:sm:mb-[4px] after:md:mb-[7px] after:w-full animate-underline">
          tailored
        </span>{" "}
        to <br />
        your needs.
